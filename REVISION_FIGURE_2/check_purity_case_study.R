...
filt_revFig_dt$dataset <- file.path(filt_revFig_dt$hicds, filt_revFig_dt$exprds)
...
setdiff(revFig_dt$regionID[revFig_dt$dataset == "GSE118514_22Rv1_40kb/TCGAprad_norm_prad" & 
                             revFig_dt$adjPvalComb <= 0.01  ],
        filt_revFig_dt$regionID[filt_revFig_dt$dataset == "GSE118514_22Rv1_40kb/TCGAprad_norm_prad" & 
                                  filt_revFig_dt$adjPvalComb <= 0.01])

setdiff(revFig_dt$regionID[revFig_dt$dataset == "GSE118514_RWPE1_40kb/TCGAprad_norm_prad" & 
                             revFig_dt$adjPvalComb <= 0.01  ],
        filt_revFig_dt$regionID[filt_revFig_dt$dataset == "GSE118514_RWPE1_40kb/TCGAprad_norm_prad" & 
                                  filt_revFig_dt$adjPvalComb <= 0.01])
