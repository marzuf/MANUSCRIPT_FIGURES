# Rscript cmp_nSignif_sampleSize_v0.R GSE105381_HepG2_40kb TCGAlihc_wt_mutCTNNB1
# Rscript cmp_nSignif_sampleSize_v0.R ENCSR312KHQ_SK-MEL-5_40kb TCGAskcm_lowInf_highInf
# Rscript cmp_nSignif_sampleSize_v0.R ENCSR079VIJ_G401_40kb TCGAkich_norm_kich
...
outFolder <- file.path("CMP_NSIGNIF_SAMPLESIZE_V0", init_hicds, init_exprds)
