...
ratioSignifFeatures_sumSample_dt <- ratioSignif_dt
saveFile <- file.path(outFolder, "fig2B_ratioSignifFeatures_sumSample_dt.Rdata")
save(ratioSignifFeatures_sumSample_dt, file=saveFile, version=2)
