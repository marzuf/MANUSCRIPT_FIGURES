...
# top 10 tads
top10_tads <- inDT$tad_id[inDT$tad_rank <= tads_nTop]

# tads of the top 100 genes
top100genes_tads <- inDT$tad_id[inDT$gene_rank <= topGenes]
...
ggbarplot(top_agg_missed_dt, x="dataset", y="missed_id")


##############################################################
############################### barplot missed tads signif tads
##############################################################
...
ggbarplot(signif_agg_missed_dt, x="dataset", y="ratioMissed")
