...
plot_dt <-  get(load("FCC_WAVE_PLOT_NOABS_PURITYFILTER_FINAL//all_fcc_dt.Rdata"))

# Rscript barplot_FCC_AUC_purityFilter.R
...
outFolder <- "BARPLOT_FCC_AUC_PURITYFILTER"
...
plot_dt$fcc_auc_minus1 <- plot_dt$fcc_auc - 1
