...
# Rscript conserved_regions_viz.R all <conserved_region_130>  <conserved_region_42> 
# Rscript conserved_regions_viz.R norm_vs_tumor <conserved_region_22> <conserved_region_9
...
outFolder <- file.path("CONSERVED_REGIONS_VIZ", cmpType)
...
for(maxConserved in conserved_regions_to_plot) {
  ...
  par(xpd=TRUE)
  plot(NULL,
       main = paste0(maxConserved, " - ", cmpTit, "datasets"),
       xlim = c(xStart, xEnd),
       # ylim = c(yStart, yEnd),
       ylim = c(0, yEnd),
       xlab = "",
