...
final_dt_file <- file.path(runFolder, "CREATE_FINAL_TABLE_PARTIAL", "all_result_dt.Rdata")
...
inFolder <- file.path(runFolder, "TAD_MATCHING_SIGNIF_ACROSS_HICDS_ALLMATCH_v2_PARTIAL", data_cmpType)
