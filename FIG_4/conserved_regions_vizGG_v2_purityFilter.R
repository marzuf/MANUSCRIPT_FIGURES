# IGV style
#Rscript conserved_regions_vizGG_v2_purityFilter.R all conserved_region_130 
# Rscript conserved_regions_vizGG_v2_purityFilter.R all <conserved_region_130>  <conserved_region_42> 
# Rscript conserved_regions_vizGG_v2_purityFilter.R norm_vs_tumor <conserved_region_22> <conserved_region_9
# Rscript conserved_regions_vizGG_v2_purityFilter.R subtypes
# Rscript conserved_regions_vizGG_v2_purityFilter.R wt_vs_mut

# Rscript conserved_regions_viz.R cmpType <regions_to_plot>

cat("> START ", "conserved_regions_vizGG_v2_purityFilter.R", "\n")
...
outFolder <- file.path("CONSERVED_REGIONS_VIZGG_V2_PURITYFILTER", cmpType, purity_ds, transfExpr)
...
inFolder <- file.path(runFolder, "TAD_MATCHING_SIGNIF_ACROSS_HICDS_ALLMATCH_v2_PURITYFILTER", cmpType, purity_ds, transfExpr)
