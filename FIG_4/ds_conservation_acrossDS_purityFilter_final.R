...
# Rscript ds_conservation_acrossDS_purityFilter_final.R
...
script_name <- "ds_conservation_acrossDS_purityFilter_final.R"
...
outFolder <- file.path("DS_CONSERVATION_ACROSSDS_PURITYFILTER_FINAL", cmpType, purity_ds, pm, transfExpr)
...
all_perm_dt <- get(load(file.path(runFolder,
                      "CONSERV_SIGNIF_OBSSHUFFLE_PURITYFILTER_FINAL", purity_ds, pm, transfExpr, "all_perm_dt.Rdata")))
...
#
# outFile <- file.path(outFolder, paste0(filePrefix, "nConserved_byRegion_allCond_noLine.", plotType))
