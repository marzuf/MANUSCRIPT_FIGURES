...
save(col.scores, file="col.scores.Rdata", version=2)
...
g0 = getOption("shaman.score_pal_pos_col")
save(g0, file="getOption.Rdata", version=2)
save(col.neg, file="col.neg.Rdata", version=2)
save(col.pos, file="col.pos.Rdata", version=2)
